...
@Slf4j
public class ConsumableSocketServer extends WebSocketServer {
	...
	/* Constructor */
	public ConsumableSocketServer(int port) {
		super(new InetSocketAddress(port));
	}
	
	/* Constructor */
	public ConsumableSocketServer(InetSocketAddress address) {
		super(address);
	}
